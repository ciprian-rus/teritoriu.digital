...
function pinnedRelease() {
  return {
    releaseTag: process.env.PUBLIC_RELEASE_TAG ?? "siruta-2026.08.05.2",
    releaseId: process.env.PUBLIC_RELEASE_ID ?? "2026.08.05.2",
    manifestSha256:
      process.env.PUBLIC_RELEASE_MANIFEST_SHA256 ??
      "a8394a84901c4155bcd28c1c4d156eb93940d165e3c6bdc37ea8f9f2c58cc80f"
  };
}
