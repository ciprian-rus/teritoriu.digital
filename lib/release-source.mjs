...
function pinnedRelease() {
  return {
    releaseTag: process.env.PUBLIC_RELEASE_TAG ?? "siruta-2026.08.05.1",
    releaseId: process.env.PUBLIC_RELEASE_ID ?? "2026.08.05.1",
    manifestSha256:
      process.env.PUBLIC_RELEASE_MANIFEST_SHA256 ??
      "36f88fc9aafb1f2ad135c344f1e2a81285dc6705feeb443acf5b464aaa8bfcb2"
  };
}
